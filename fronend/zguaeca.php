...
<body>
    ...
    <div class="container p-0" id="guaecaTopo">
            <h1>GUAECA</h1>
            <nav class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="nav justify-content-between">
                    <li class="nav-link"><a href="zpauba.php">PRAIA ANTERIOR</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                        <img src="imagens/img-previsao/guaeca.jpeg" class="img-fluid" style="width: 400px;" alt="responsive image">
                    </div>
    ...
    <div class="container text-center mt-5 mb-5">
        <a href="#guaecaTopo" class="btn encontreBotao">Topo</a>
    </div>
