...
<body>
    ...
    <div class="container p-0" id="paubaTopo">
            <h1>PAUBA</h1>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                        <img src="imagens/img-previsao/pauba.jpg" class="img-fluid mb-3" alt="responsive image">
                    </div>
    ...
    <div class="container text-center mt-5 mb-5">
        <a href="#paubaTopo" class="btn encontreBotao">Topo</a>
    </div>
