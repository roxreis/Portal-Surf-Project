...
<body>
    ...
    <main class="container p-0" id="barradounaTopo">
        <h1>BARRA DO UNA</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                    <img src="imagens/img-previsao/barradouna.jpg" class="img-fluid" style="width: 400px;"
                        alt="responsive image">
                </div>
                <div class="col-xl-7 col-lg-6 col-md-12 col-sm-12">
                    <p>Um dos picos alternativos da região, a Barra da Una é uma excelente opção para os dias de mar
                        fora de controle nos picos mais expostos.</p>
                    <ul>
        ...
        <div class="container text-center mt-5 mb-5">
            <a href="#barradounaTopo" class="btn encontreBotao">Topo</a>
        </div>
    </main>
