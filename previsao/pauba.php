    ...
    <div class=container>
            ...
            <nav>
                <ul class="nav justify-content-between">
                    <li class="nav-link"><a href="maresias.php">PRAIA ANTERIOR</a></li>
                    <li class="nav-link"><a href="previsao.php">VOLTAR</a></li>
                    <li class="nav-link"><a href="guaeca.php">PROXIMA PRAIA</a></li>
                </ul>
            </nav>
            <div class="d-flex flex-row mr-3">
                <img src="imagens/pauba.jpg" class="img-fluid" style="width: 400px;" alt="responsive image">
